<div align="center">
  <img src="assets/malachite-structure.png" alt="Malachite Structure" width="400" />
  
  # 💎 Project Malachite (v8.0)
  ...
  [![Status: Stable](https://img.shields.io/badge/Status-Stable_v8.0-green.svg)]()
...
## 🔭 The Holoscope (Visualization)

**Don't just read the data. See the organism.**
...
### 2. Generative Core
Data is not entered manually. It is grown by Python simulators located in `_generators/`. This ensures physical consistency across thousands of objects.
...
### 3. Validate Chains
Check if all supply chains are physically possible (no missing resources).
```bash
python _generators/validate_supply_chains.py
```
